...
public class ExperimentalSettings {
	...
	public boolean combineMultipleAggregates = false;		// OPT1: true = multiple measures together
	public int maxAggSize = 1;								// OPT1: combine aggregates UP to maxAggSize
	
	public boolean combineMultipleGroupBys = false;			// OPT2: combine group-bys together in one query
	...
	public String logFile = "output.txt";							// log file for profiling, set if you want
															// else goes to stdout
