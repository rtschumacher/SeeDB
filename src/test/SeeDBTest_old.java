...
public class SeeDBTest_old {
	//private String defaultQuery1 = "select * from election_data where dim_cand_name='McCain, John S'"; //"select * from table_10_2_2_3_2_1 where measure1 < 2000";
	private String defaultQuery1 = "SELECT * FROM bank WHERE age=35";
	...
	private String seeDBTestDir = "C:/Users/uqhehsan/Dropbox/Results/";
	...
	public void connectToDatabaseTest() {
		SeeDB seedb = new SeeDB();
		System.out.println("Inside ConnectToDatabaseTest");
