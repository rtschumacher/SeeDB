...
public class EndToEndTests {
	...
	private String query1 = "SELECT * FROM " + table + " WHERE age=35";
	private String query2 = "SELECT * FROM " + table + " WHERE marital='married'";
	...
	private void runSeeDB(String query, ExperimentalSettings settings, DBSettings s) {
		...
		if (settings.backend != Backend.MAIN_MEMORY) {
			try {
				...
				seedb.initialize(query1, query2, settings);
